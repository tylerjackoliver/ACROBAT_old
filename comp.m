...
global mu ep mp1 mp2 distscale theta_l theta_u h_l h_u req sma f maxt
% Unused variables -  r1 r2 theta1 theta
%% Variable computation

mp1 = 123;  % mass of larger primary
mp2 = 456;  % mass of smaller primary
mu = mp2/(mp1+mp2);% calculate system mass ratio
